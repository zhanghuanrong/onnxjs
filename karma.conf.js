...
function getMachineIpAddress() {
  ...
  for (const ifname in ifaces) {
    for (const iface of ifaces[ifname]) {
      if ('IPv4' !== iface.family || iface.internal !== false || ifname.startsWith('vEthernet')) {
        // skip over internal (i.e. 127.0.0.1) and non-ipv4 addresses, and WSL used virtual interface
        continue;
      }
